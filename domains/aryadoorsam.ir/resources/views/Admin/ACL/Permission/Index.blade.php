                        ...
                        @foreach($permissions  as $permission)
                            ...
                            @if($loop->even)
                                <tr class="intro-x">
                                    ...
                                    <td>
                                        <a href="" class="font-medium whitespace-no-wrap flex-justify-start">{{$permission->title}}</a>
...
{{--                {{$brands->links()}}--}}
@include('Admin.Pagination.index', ['paginator' => $permissions,'route' => 'admin.permission'])
</div>
<!-- END: Pagination -->
</div>
            ...
            <div class="modal__content rtl">
                <form action="{{route('admin.permission.update',$permission)}}" method="post">
                    ...
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
                        ...
                        <p>ویرایش دسترسی {{$permission->title}}</p>
                    </div>
                    <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                        ...
                        <div class="col-span-12 sm:col-span-6"> <label>نام فارسی</label>
                            <div class="relative mt-2">
                                <input type="text" required name="title" class="input pl-12 w-full border col-span-4 " value="{{old('title',$permission->title)}}">
                            </div>
                        </div>
                    </div>
...
<div class="text-3xl mt-5">حذف دسترسی   <span style="color: #8b0000">{{$permission->title}}</span></div>
{{--                        <div class="mt-3 ">--}}
