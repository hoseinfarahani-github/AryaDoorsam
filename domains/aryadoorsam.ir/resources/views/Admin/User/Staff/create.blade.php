    ...
    <div class="intro-y box py-10 sm:py-20 mt-5">
        <div class=" nav-tabs pos__tabs wizard flex flex-col lg:flex-row justify-center px-5 sm:px-20 rtl">
            ...
            <div class="intro-x lg:text-center flex items-center mt-5 lg:mt-0 lg:block flex-1 z-10">
                ...
                <div class="intro-x lg:text-center flex items-center mt-5 lg:mt-0 lg:block flex-1 z-10">
                    <a id="s4" data-toggle="tab" data-target="#step4" href="javascript:;" class=" disabled w-10 h-10 rounded-full button text-gray-600 bg-gray-200 ">4</a>
                    <div class="lg:w-32 text-base lg:mt-3 ml-3 lg:mx-auto text-gray-700">دسترسی و نقش</div>
                </div>
        ...
        <form action="{{route('admin.user.staff.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="tab-content pos">
                        ...
                        <div class=" ml-2 col-span-4">
                            ...
                            <select id="province"  class="mt-2 input select-2 block w-full border"name="province" onchange="selectProvince()">
                                ...
                                @foreach($province as $pro)
                                    ...
                                    <option  value="{{$pro->id}}" label="{{$pro->title}}">{{$pro->title}}</option>
                                @endforeach
                ...
                <div id="step3" class="tab-content__pane  px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 " >
                    ...
                    <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5 rtl">
                        ...
                        <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5 mr-auto">
                            <a data-toggle="tab"   data-target="#step4" href="#/s4"  id="s3next" class="disabled button w-24 justify-center block bg-gray-600 text-white ml-2 mr-2">بعدی</a>
                ...
                <div id="step4" class="tab-content__pane  px-5 sm:px-10 mt-10 pt-10 border-t border-gray-200 " >
                    <div class="col-span-12 lg:col-span-12">
                        ...
                        <div class="intro-y pr-1">
                            ...
                            <div class="box p-2">
                                <div class="pos__tabs nav-tabs justify-center flex">
                                    <a data-toggle="tab" data-target="#role" href="javascript:;" class="flex-1 py-2 rounded-md text-center ">مقام ها</a>
                    ...
                    <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5 mr-auto">
                        ...
                        <a data-toggle="tab" data-target="#step3" href="#/s3"id="s4perv" class="button w-24 justify-center block bg-gray-200 text-gray-600">قبلی</a>
...
@section('js')
    ...
    <script src="/Admin/assets/js/CategoryImageUploader.js"> </script>
    <script>
        ...
        $('#s4perv').click(function() {
            ...
            $('#s3').addClass('text-white');
            $('#s3').addClass('bg-theme-1');
            $('#s4').removeClass('bg-theme-1','text-white');
            $('#s4').addClass('bg-gray-200','text-gray-600');
        });
        $('#s1').click(function() {
            $('#s1').addClass('text-white');
            $('#s1').addClass('bg-theme-1');
            ...
            $('#s4').removeClass('text-white');
            $('#s4').removeClass('bg-theme-1');
            $('#s4').addClass('text-gray-600');
            $('#s4').addClass('bg-gray-200');
        });
        $('#s2').click(function() {
            $('#s2').addClass('bg-theme-1');
            $('#s2').addClass('text-white');
...
@component('Admin.Layout.layout')
    @slot('breadcrump')
        <div class="-intro-x breadcrumb ml-auto hidden sm:flex">
            ...
            <a href="{{route('admin.user.staff.index')}}" class="breadcrumb--active">لیست مدیران</a>
             <i data-feather="chevron-right" class="breadcrumb__icon"></i>
