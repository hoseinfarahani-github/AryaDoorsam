        ...
        <form action="{{route('admin.client.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="tab-content pos">
                <div id="step1" class="tab-content__pane active px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200" >
                    <div class="font-medium text-base">اطلاعات مشتری</div>
                    <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5 rtl">
                        ...
                        <div class="intro-y col-span-12 sm:col-span-5">
                            <div class="mb-2"><label for="clientname">نام مشتری<i data-feather="user" class="w-4 h-4 float-right ml-2 text-blue-400"></i></label></div>
                            <input type="text" name="clientname" class="input w-full border flex-1" placeholder="نام مشتری" id="clientname">
                        </div>
                        <div class="intro-y col-span-12 sm:col-span-1">
                            <div class="mb-2"><label for="email"> وضعیت</label></div>
                            <input type="checkbox" checked class="tooltip input input--switch border " style="direction: ltr !important;" value="1" name="status" > </div>
                        ...
                        <div class=" ml-2 col-span-3">
                            <label for="agent"><i data-feather="map" class="w-4 h-4 float-right ml-2 text-blue-400"></i>انتخاب نماینده</label>
                            <select id="agent" class="mt-2 input select-2 block w-full border" name="agent" >
                                <option disabled selected="selected" > انتخاب نماینده</option>
                                @foreach($agents as $agent)
                                    <option value="{{$agent->id}}" class="align-right" style="direction: rtl">  {{__('users.' . $agent->user->username)}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class=" ml-2 col-span-4">
                            ...
                            <select id="province"  class="mt-2 input select-2 block w-full border" name="province" onchange="selectProvince()">
                                ...
                                @foreach($provinces as $province)
                                    ...
                                    <option  value="{{$province->id}}" label="{{$province->title}}">{{$province->title}}</option>
                                @endforeach
                        ...
                        <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5 mr-auto">
                            <a data-toggle="tab"   data-target="#step2" href="#/s2"  id="s1next" class=" button w-24 justify-center block bg-gray-600 text-white ml-2 mr-2">بعدی</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="p-5 " id="input">
                                            <div class="preview rtl grid grid-cols-12">
                                                ...
                                                <div class=" ml-2 col-span-4">
                                                    ...
                                                    <input name="companyName" id="companyName"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder="نام شرکت"  >
                                                </div>

                                                <div class=" ml-2 col-span-4">
                                                    <label for="contactPerson"><i data-feather="credit-card" class="w-4 h-4 float-right ml-2 text-blue-400"></i>  نام رابط شرکت</label>
                                                    <input name="contactPerson" id="contactPerson"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder=" نام رابط شرکت"  >
                                                </div>

                                                <div class=" ml-2 col-span-4">
                                                    <label for="contactPhone"><i data-feather="credit-card" class="w-4 h-4 float-right ml-2 text-blue-400"></i>  شماره شرکت </label>
                                                    <input name="contactPhone" id="contactPhone"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder="شماره شرکت"  >
                                                </div>

                                                <div class=" ml-2 mt-2 col-span-3">
                                                    <label for="contactPhone"><i data-feather="credit-card" class="w-4 h-4 float-right ml-2 text-blue-400"></i>   شماره نماینده شرکت</label>
                                                    <input name="contactPhone" id="activity"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder=" شماره نماینده شرکت"  >
                                                </div>

                                                <div class=" ml-2 mt-2 col-span-3">
                                                    <label for="nationalNumber"><i data-feather="user" class="w-4 h-4 float-right ml-2 text-blue-400"></i>   شناسه ملی شرکت</label>
                                                    <input name="nationalNumber" id="nationalNumber"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder="شناسه ملی شرکت" >
                                                </div>
                                                <div class=" ml-2 mt-2 col-span-3">
                                                    <label for="savedNumber"><i data-feather="user" class="w-4 h-4 float-right ml-2 text-blue-400"></i>  شناسه ثبت شرکت  </label>
                                                    <input name="savedNumber" id="savedNumber"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder="شناسه ثبت شرکت" >
                                                </div>
                                                <div class=" ml-2 mt-2 col-span-3">
                                                    <label for="economicNumber"><i data-feather="phone-call" class="w-4 h-4 float-right ml-2  text-blue-400"></i>شناسه اقتصادی شرکت   </label>
                                                    <input name="economicNumber" id="economicNumber"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder="شناسه اقتصادی شرکت"  >
                                                </div>
                                    ...
                                    <div class="intro-y box">
                                        ...
                                        <div class="p-5 " id="input">
                                            <div class="preview rtl grid grid-cols-12">
                                                ...
                                                <div class=" ml-2 col-span-6 col-6">
                                                ...
                                                <div class=" ml-2 mt-3 col-span-6">
                                                    <label for="occupation"><i data-feather="edit-2" class="w-4 h-4 float-right ml-2  text-blue-400"></i>شماره همراه</label>
                                                    <input name="phone" id="occupation"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder="شماره همراه">
                                                </div>
                                                <div class="mt-3 ml-2 col-span-6">
                                                    <label for="nationalNumberPerson"><i data-feather="edit-2" class="w-4 h-4 float-right ml-2 text-blue-400"></i>کد ملی</label>
                                                    <input name="nationalNumberPerson" id="national"  type="text" class="input w-full border mt-2 align-right" style="direction: rtl" placeholder="کد ملی">
                                                </div>
                ...
                <div id="step3" class="tab-content__pane  px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 " >
                    <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200  bg-indigo-100 rounded">
                        <p>در این بخش درباره کاربر و عکس مشتری را انتخاب کنید</p>
                    </div>
                    <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5 rtl">
                        <div class="intro-y col-span-12 sm:col-span-6">
                            <div class="mb-2">درباره مشتری</div>
                            ...
                            <div class="intro-y ">
                                <div id="uploadArea1" class="upload-area ">
                                    ...
                                    <div class="upload-area__header">
                                        <h1 class="upload-area__title" id="dropZoneNameHype1">عکس مشتری</h1>
...
@section('js')
    ...
    <script src="/Admin/assets/js/Address.js"> </script>
    <script>
...
@component('Admin.Layout.layout')
    @slot('breadcrump')
        <div class="-intro-x breadcrumb ml-auto hidden sm:flex">
            <a  class="" disabled >ایجاد مشتری</a>
            <i data-feather="chevron-right" class="breadcrumb__icon"></i>
            <a href="{{route('admin.client.index')}}" class="breadcrumb--active" >مشتریان</a>
            <i data-feather="chevron-right" class="breadcrumb__icon"></i>
