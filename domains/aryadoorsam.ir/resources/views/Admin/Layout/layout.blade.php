...
<div class="flex">
  ...
  @can('show-orders')
                <li>
                    <a href="javascript:;" class="side-menu {{side_menu_active(['dashboard/order'],'side-menu--active')}}">
                        <div class="side-menu__icon"> <i data-feather="shopping-cart"></i> </div>
                        <div class="side-menu__title"> سفارش ها  <i data-feather="chevron-down" class="side-menu__sub-icon"></i> </div>
                    </a>
                    <ul class="{{side_menu_active(['dashboard/product'],'side-menu__sub-open')}}">
                        <li>
                            <form action="{{route('admin.order.index')}}" method="post">
                                @csrf
                                <button type="submit" class="side-menu mr-0 ml-auto foc" style="color: #c7d2ff">
                                    <div class="side-menu__icon"> <i data-feather="activity"></i> </div>
                                    <div class="side-menu__title"> سفارش ها </div>
                                </button>
                            </form>
                        </li>
                        @can('create-order')
                            <li>
                                <a href="{{route('admin.order.create')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="edit-2"></i> </div>
                                    <div class="side-menu__title"> ایجاد سفارش </div>
                                </a>
                            </li>
                        @endcan
                    </ul>
                    ...
                    <ul class="{{side_menu_active('dashboard/user','side-menu__sub-open')}}">
                            <li>
                                <a href="{{route('admin.user.index')}}" class="side-menu">
                                    ...
                                    <div class="side-menu__title"> کاربران سایت </div>
                                </a>
                                <a href="{{route('admin.client.index')}}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="user"></i> </div>
                                    <div class="side-menu__title"> مشتریان سایت </div>
                                </a>
                            </li>
                    </ul>
                </li>
            ...
            @can('show-tickets')
                <li>
                    <a href="{{route('admin.gallery.index')}}"
                       class="side-menu {{side_menu_active('dashboard/gallery','side-menu--active')}} " type="button" id="button-image">
                ...
                <li>
                    ...
                    <ul class="{{side_menu_active('dashboard/reports','side-menu__sub-open')}}">
                        ...
                        <li>
                            <a href="" class="side-menu">
                                <div class="side-menu__icon"> <i data-feather="edit"></i> </div>
                                <div class="side-menu__title"> گزارش سفارش ها </div>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            @can('show-tickets')
                <li>
                    <a href="{{route('admin.ticket.index')}}"
                       class="side-menu {{side_menu_active('dashboard/tickets','side-menu--active')}} " type="button" id="button-image">
                        <div class="side-menu__icon"> <i data-feather="message-square"></i> </div>
                        <div class="side-menu__title">تیکت ها  </div>
                    </a>
                </li>
            @endcan
            <li class="side-nav__devider my-6"></li>
            ...
            @can('show-news')
                <li>
                    <a href="{{route('admin.news.index')}}"
                       class="side-menu {{side_menu_active('dashboard/news','side-menu--active')}} " type="button" id="button-image">
                        <div class="side-menu__icon"> <i data-feather="paperclip"></i> </div>
                        <div class="side-menu__title">اخبار </div>
                    </a>
                </li>
            @endcan
            ...
            <li>
                <a href=""
                   class="side-menu {{side_menu_active('dashboard/news','side-menu--active')}} " type="button" id="button-image">
                    ...
                    <div class="side-menu__title">DataBase </div>
                </a>
            </li>
            ...
            @can('show-hints')
                <li>
                    <a href="{{route('admin.hints.index')}}"
                       class="side-menu {{side_menu_active('dashboard/news','side-menu--active')}} " type="button" id="button-image">
                        <div class="side-menu__icon"> <i data-feather="help-circle"></i> </div>
                        <div class="side-menu__title">راهنما </div>
                    </a>
                </li>
            @endcan
        </ul>
        ...
        <div class="top-bar ">
            ...
            <div class="intro-x relative mr-3 sm:mr-6" style="margin-left: 5px">
                ...
                <div class="search-result">
                    <div class="search-result__content rtl">
