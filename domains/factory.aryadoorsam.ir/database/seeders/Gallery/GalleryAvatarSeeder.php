...
class GalleryAvatarSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('galleries')->insert([
            ...
            'size' => number_format(filesize('public/assets/image/avatar/default_man_avatar01.png')/1024,0),
        ...
        DB::table('galleries')->insert([
            ...
            'size' => number_format(filesize('public/assets/image/avatar/default_woman_avatar01.png')/1024,0),
            'galleria_type'=>'App\Models\User\User',
            'mime'=>'png',
        ...
        DB::table('galleries')->insert([
            ...
            'size' => number_format(filesize('public/assets/image/avatar/default_company_avatar01.png')/1024,0),
        ...
        DB::table('galleries')->insert([
            ...
            'size' => number_format(filesize('public/assets/image/avatar/default_personal_avatar01.png')/1024,0),
