                ...
                <div class="col-sm-12">
                    <div class="card card-table">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-1">
                                <a href="{{route('factory.ticket.create')}}" class="btn theme-bg-color text-white btn-sm fw-bold mt-lg-0 mt-3">
                                        ...
                                        <table class="user-table ticket-table review-table theme-table table"
                                            ...
                                            @foreach($tickets as $ticket)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{__('users.'.$ticket->sender_user->username)}}</td>
                                                    <td>{{__('users.'.$ticket->receiver_user->username)}}</td>
                                                    <td>
                                                        <ul class="rating">
                                                            @for($c=1;$c <6;$c++)
                                                                <li>
                                                    ...
                                                    <td class="td-check">
                                                        ...
                                                        <a href="{{route('factory.ticket.show',$ticket)}}"> <i class="ri-eye-line"></i> </a>
                                                    </td>
