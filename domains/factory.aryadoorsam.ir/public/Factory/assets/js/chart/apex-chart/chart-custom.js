...
var chartArray=JSON.parse(document.getElementById('chart-revenue').innerHTML)
var chartArrayKey=Object.keys(chartArray)
var newkey=[]
chartArrayKey.forEach(function (kk){
    switch (kk){

        case '1' : newkey.push('فروردین')
            break
        case '2' : newkey.push('اردیبهشت')
            break
        case '3' : newkey.push('خرداد')
            break
        case '4' : newkey.push('تیر')
            break
        case '5' : newkey.push('مرداد')
            break
        case '6' : newkey.push('شهریور')
            break
        case '7' : newkey.push('مهر')
            break
        case '8' : newkey.push('آبان')
            break
        case '9' : newkey.push('آذر')
            break
        case '10' : newkey.push('دی')
            break
        case '11' : newkey.push('بهمن')
            break
        case '12' : newkey.push('اسفند')
            break
    }
})
