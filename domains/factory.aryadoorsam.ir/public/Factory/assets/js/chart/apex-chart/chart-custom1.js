...
var chartArray=JSON.parse(document.getElementById('pie-chart').innerHTML)
var chartArrayKey=Object.keys(chartArray)
var chartArrayvalue=Object.values(chartArray)
var options = {
    series: chartArrayvalue,
    labels: chartArrayKey,
    chart: {
        width: "100%",
        height: 275,
        type: 'donut',
    ...
    colors: ['#db2929', '#fa6f12', '#febd03', '#21ba45', '#00b6b0','#2a82cc','#6335c9'],
