        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <div class="main-tiles border-5 border  card-hover card o-hidden">
                ...
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <div class="main-tiles border-5 card-hover border card o-hidden">
               ...
               {{-- <div class="col-12">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="card border border-2  o-hidden card-hover">
                                            ...
                                            @foreach($user_orders as $user_order)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            <li>
                                                                <a href="{{route('manager.order.detail',$user_order)}}">
										 ...
										 @if($user_order_count > 4)
                                            <div class="">
                                                ...
                                                <div class="button-box">
                                                    <a href="{{route('manager.order.index')}}" class="btn  btn--yes border  border-2">نمایش بیشتر({{$user_order_count-4}})..</a>
                                                </div>
                                            </div>
                                        @endif
