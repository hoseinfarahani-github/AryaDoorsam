                    ...
                    <li class="profile-nav onhover-dropdown pe-0 me-0">
                        <div class="media profile-media">
                            ...
                            <div class="user-name-hide media-body">
                                ...
                                <p class="mb-0 font-roboto">نماینده<i class="middle ri-arrow-down-s-line"></i></p>
                            </div>
                        </div>
                        <ul class="profile-dropdown onhover-show-div">
                            <li>
                                <a href="{{route('agent.client.index')}}">
                            ...
                            <li>
                                <a href="{{route('agent.setting.index')}}">
                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav active" href="{{route('agent.dashboard.index')}}">
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav " href="{{route('agent.product.index')}}">
                            ...
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li>
                                        <a href="{{route('agent.order.create')}}">سفارش جدید</a>
                                    </li>

                                    <li>
                                        <a href="{{route('agent.order.index')}}">جدول سفارش ها</a>
                                    </li>

									<li>
                                        <a href="{{route('agent.order.graphic.index')}}">شماتیک سفارش ها</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="sidebar-list">
                                ...
                                <ul class="sidebar-submenu">
                                    <li>
                                        <a href="{{route('agent.client.index')}}">لیست مشتریان</a>
                                    </li>
                                    <li>
                                        <a href="{{route('agent.client.create')}}">افزودن مشتری</a>
                                    </li>
                                </ul>
                            </li>
							
							 <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{route('agent.ticket.index')}}">
                            ...
                            <li class="sidebar-list">
                                <a class="sidebar-link sidebar-title link-nav" href="{{route('agent.setting.index')}}">
...
<!-- ck editor js -->
<script src="/Agent/assets/js/ckeditor.js"></script>
<script src="/Agent/assets/js/ckeditor-custom.js"></script>

<!--Dropzon js -->
<script src="/Agent/assets/js/dropzone/dropzone.js"></script>
<script src="/Agent/assets/js/dropzone/dropzone-script.js"></script>


<!-- select2 js -->
<script src="/Agent/assets/js/select2.min.js"></script>
<script src="/Agent/assets/js/select2-custom.js"></script>
