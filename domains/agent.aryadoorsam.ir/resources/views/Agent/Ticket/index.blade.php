                ...
                <div class="col-sm-12">
                    <div class="card card-table">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-1">
                                <a href="{{route('agent.ticket.create')}}" class="btn theme-bg-color text-white btn-sm fw-bold mt-lg-0 mt-3">
                                            ...
                                            @foreach($tickets as $ticket)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-check">
                                                        ...
                                                        <a href="{{route('agent.ticket.show',$ticket)}}"> <i class="ri-eye-line"></i> </a>
                                                    </td>
